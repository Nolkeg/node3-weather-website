...
const reverseGeocode = ({latitude,longitude},callback)=>{
    ...
    url = `https://api.mapbox.com/geocoding/v5/mapbox.places/${longitude},${latitude}.json?&access_token=pk.eyJ1Ijoibm9sa2VnIiwiYSI6ImNqcXphdWkxMDBjaGs0NGxzMnJqMDdyMmoifQ.OBeUYLP3sQw1aoFd_r8GNw`
